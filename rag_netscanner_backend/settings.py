"""
Django settings for rag_netscanner_backend project.
...
ROOT_URLCONF = 'rag_netscanner_backend.urls'
...
WSGI_APPLICATION = 'rag_netscanner_backend.wsgi.application'
...
# Media files (for potential file uploads/previews later)
MEDIA_URL = '/media/'
